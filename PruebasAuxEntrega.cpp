...
void pruebaUnionListaOrd(const char* inputList1, const char* inputList2)
{
	...
	int largoLista1;
	int largoLista2;
	NodoListaIntFramework* lista1 = (NodoListaIntFramework*)FrameworkA1::parsearColeccion(inputList1, largoLista1);
	NodoListaIntFramework* lista2 = (NodoListaIntFramework*)FrameworkA1::parsearColeccion(inputList2, largoLista2);
...
void pruebaObtenerRepetidos(const char* lista)
{
	...
	int largo;
	NodoListaIntFramework* listaParseada = (NodoListaIntFramework*)FrameworkA1::parsearColeccion(lista, largo);
...
void pruebaXor(const char* inputMultiSet1, const char* inputMultiSet2)
{
	...
	int largoLista1;
	int largoLista2;
	NodoListaIntFramework* lista1 = (NodoListaIntFramework*)FrameworkA1::parsearColeccion(inputMultiSet1, largoLista1);
	NodoListaIntFramework* lista2 = (NodoListaIntFramework*)FrameworkA1::parsearColeccion(inputMultiSet2, largoLista2);
...
{
	int largoLista;
	NodoListaIntFramework* cp1elem = (NodoListaIntFramework*)FrameworkA1::parsearColeccion(inputCpElem, largoLista);
	NodoListaIntFramework* cp1prio = (NodoListaIntFramework*)FrameworkA1::parsearColeccion(inputCpPrio, largoLista);

	cout << "Llamada: " << "MenorPrioridad" << "((";
	NodoListaIntFramework* ptre = cp1elem;
	NodoListaIntFramework* ptrp = cp1prio;
	while (ptre != NULL)
	{
