...
namespace FrameworkA1
{
	...
	*/
	FRAMEWORKA1DLL_API void imprimirEsperadoVsRecibido(NodoListaIntFramework *esp, NodoListaIntFramework *rec);
	/*
	PRE:
	POS: imprime resultado esp vs rec y también los paramtros de entrada
	*/
	FRAMEWORKA1DLL_API void imprimirEsperadoVsRecibido(NodoListaIntFramework *esp, NodoListaIntFramework *rec, const char *inputParametersFormated);
	/*
	PRE: 
	POS: imprime resultado esp vs rec y también los paramtros de entrada
	*/
	...
	POS: imprime resultado esp vs rec y también los paramtros de entrada
	*/
	FRAMEWORKA1DLL_API void imprimirEsperadoVsRecibido(NodoAGIntFramework *esp, NodoAGIntFramework *rec, const char *inputParametersFormated);
	/*
	PRE: 
	POS: imprime resultado esp vs rec y también los paramtros de entrada
	*/
	...
	*/
	FRAMEWORKA1DLL_API bool sonIgualesDatosForma(NodoListaIntFramework *l1, NodoListaIntFramework *l2);
	/*
	PRE:
	POS: devuelve true si los arboles tienen los mismos datos
	*/
	FRAMEWORKA1DLL_API bool sonIgualesDatos(NodoListaIntFramework *l1, NodoListaIntFramework *l2);
	/*
	PRE:
	...
	*/
	...
	POS: devuelve true si los arboles tienen los mismos datos y misma forma
	*/
	FRAMEWORKA1DLL_API bool sonIgualesDatosForma(NodoAGIntFramework *a1, NodoAGIntFramework *a2); 
	/*
	PRE:
	POS: devuelve true si los arboles tienen los mismos datos
	*/
	FRAMEWORKA1DLL_API bool sonIgualesDatos(NodoAGIntFramework *a1, NodoAGIntFramework *a2);
	/*
	...
	*/
	FRAMEWORKA1DLL_API bool compartenMemoria(NodoListaIntFramework *l1, NodoListaIntFramework *l2);
	/*
	...
	*/
	...
	POS: devuelve true si a1 y a2 comparten memoria
	*/
	FRAMEWORKA1DLL_API bool compartenMemoria(NodoAGIntFramework *a1, NodoAGIntFramework *a2);
	...
	*/
	FRAMEWORKA1DLL_API void destruir(NodoListaIntFramework*& l);
	/*
	PRE:
	POS: destruye la lista l
	*/
	FRAMEWORKA1DLL_API void destruir(NodoListaStringFramework*& l);
	/*
	PRE:
	...
	*/
	...
	POS: destruye arbol a
	*/
	FRAMEWORKA1DLL_API void destruir(NodoAGIntFramework*& a);
	...
	*/
	FRAMEWORKA1DLL_API void agregarOrd(NodoListaIntFramework*& l, int val);
	...
	*/
	...
	POS: convierte stringDatos a un arbol, lista, vector int o vector strings.
		 se debe castear al tipo (NodoABInt *), (NodoAGIntFramework *), (NodoLista *), (int *), (char **)
	*/
	...
	*/
	FRAMEWORKA1DLL_API char *serializar(NodoListaIntFramework *l);
	/*
	PRE:
	...
	*/
	FRAMEWORKA1DLL_API char *serializar(NodoAGIntFramework *a);
	/*
	PRE:
